class PressesController < ApplicationController
  ...
  # GET /presses/1.json
  def show
  	 @products_of_this_press = @press.products
  	 @products_for_thumbnail = @products_of_this_press.order(view: :desc).first(3)
  	 @products_for_media = @products_of_this_press.order(view: :desc).offset(3).limit(5)
  end
  ...
  private
    ...
    def press_params
      params.require(:press).permit(:name, :adress, :tel, :web)
    end
end
